function [matrix_acc, feature_list, model_list, par_list, foldid] = cvfs(train, test, cp)
if ~iscell(train)
...
%% Output Result Table %%
matrix_acc = zeros(9, 11);
feature_list = cell(9,1);
model_list = cell(9,1);
par_list = cell(9,1);
...
%% Glmnet Logistic Regression: alpha=0:0.1:1 %%
